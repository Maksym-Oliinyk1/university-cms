...
public class NameValidator {
    ...
    private static final String FILTER_ON_THE_MINIMUM_NUMBER_OF_LETTERS =
    ...
    private static final String FILTER_ON_ACCEPTABLE_FORM_OF_EMAIL =
    ...
    public static boolean isValidEmail(String email) {
        return email.matches(FILTER_ON_ACCEPTABLE_FORM_OF_EMAIL);
    }
}
