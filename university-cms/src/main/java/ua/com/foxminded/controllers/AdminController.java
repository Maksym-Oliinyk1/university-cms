...
public interface AdminController {
    ...
    @Operation(summary = "Save new administrator", description = "Creates and saves a new administrator")
    @ApiResponses(value = {
    ...
    @PostMapping
    ResponseEntity<AdministratorDTO> save(
            @RequestBody @Valid AdministratorDTO administratorDTO);

    @Operation(summary = "Update existing administrator", description = "Updates details of an existing administrator")
    @ApiResponses(value = {
    ...
    ResponseEntity<AdministratorDTO> update(
            @RequestBody @Valid AdministratorDTO administratorDTO,
            @PathVariable @Valid UUID adminId);

    @Operation(summary = "Get administrator by ID", description = "Fetches an administrator by its ID")
    @ApiResponses(value = {
