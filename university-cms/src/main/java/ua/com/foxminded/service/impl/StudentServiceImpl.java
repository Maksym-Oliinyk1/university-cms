...
public class StudentServiceImpl implements StudentService {
  ...
  public StudentDTO save(StudentDTO studentDTO) {
    ...
    if (studentDTO.getImage() == null || studentDTO.getImage().isEmpty()) {
      ...
      return userMapper.mapToDto(studentRepository.save(student));
    } else {
      Student student = userMapper.mapFromDto(studentDTO);
      student = studentRepository.save(student);
      String imageName =
              imageService.saveUserImage(STUDENT_ROLE, studentDTO.getImage());
  ...
  @Override
  public StudentDTO findByIdDTO(UUID id) {
