...
class TeacherControllerIntegrationTest extends BaseIntegrationTest {
  ...
  void showUpdateForm() throws Exception {
    ...
    TeacherDTO teacherFromModel = (TeacherDTO) model.get("teacher");
    Teacher teacherCastedFromDto = userMapper.mapFromDto(teacherFromModel);

    baseTestForUser(teacherCastedFromDto);
    assertEquals("Ph.D", teacherFromModel.getAcademicDegree());
  }
